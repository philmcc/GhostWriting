...
# load data
dataset = loadtxt('Datasets/training_dataset_reduced_04.csv', delimiter="|")
...
our_params = {'eta': 0.1, 'seed':0, 'subsample': 0.9, 
            'objective': 'binary:logistic', 'max_depth':8, 'min_child_weight':1, 'n_estimators':200, 'learning_rate':0.1} 
